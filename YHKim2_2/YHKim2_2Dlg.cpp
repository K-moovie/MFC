...
// YHKim2_2Dlg.cpp: 구현 파일
//

#include "stdafx.h"
#include "YHKim2_2.h"
#include "YHKim2_2Dlg.h"
...
CYHKim22Dlg::CYHKim22Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_YHKIM2_2_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CYHKim22Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
}

BEGIN_MESSAGE_MAP(CYHKim22Dlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
...
void CYHKim22Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CYHKim22Dlg::OnQueryDragIcon()
{
