...
// YHKimEx3_2Dlg.cpp: 구현 파일
//

#include "stdafx.h"
#include "YHKimEx3_2.h"
#include "YHKimEx3_2Dlg.h"
...
CYHKimEx32Dlg::CYHKimEx32Dlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_YHKIMEX3_2_DIALOG, pParent)
{
...
// CYHKimEx32Dlg 메시지 처리기

BOOL CYHKimEx32Dlg::OnInitDialog()
{
...
void CYHKimEx32Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CYHKimEx32Dlg::OnQueryDragIcon()
{
